              ...
              <form action="#!">
                <div className="row gy-4 gy-xl-5 p-4 p-xl-5">
                  <div className="col-12">
                    <label for="fullname" className="form-label">Nombre <span className="text-danger">*</span></label>
                  ...
                  <div className="col-12 col-md-6">
                    <label for="phone" className="form-label">Número de telefono</label>
                    <div className="input-group">
                      <span className="input-group-text">
                  ...
                  <div className="col-12">
                    <label for="subject" className="form-label">Tema <span className="text-danger">*</span></label>
