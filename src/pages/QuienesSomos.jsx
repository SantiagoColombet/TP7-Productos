              ...
              <div className="col-12 col-xl-11">
                <div className="mb-4 mb-md-5">
                  ...
                  <div>
                    ...
                    <address className="m-0 text-secondary">Gurruchaga 400, Villa Crepo, Buenos Aires, Argentina</address>
                  </div>
                </div>
                <div className="row mb-sm-4 mb-md-5">
                  <div className="col-12 col-sm-6">
                    <div className="mb-4 mb-sm-0">
                      ...
                      <div>
                        <h4 className="mb-2">Telefono</h4>
                        <p className="mb-2"></p>
                        <hr className="w-75 mb-3 border-dark-subtle"/>
                        <p className="mb-0">
                          <a className="link-secondary text-decoration-none" href="tel:+15057922430">54 11 4792-2430</a>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-sm-6">
                    <div className="mb-4 mb-sm-0">
                      ...
                      <div>
                        ...
                        <hr className="w-75 mb-3 border-dark-subtle"/>
                        <p className="mb-0">
                          <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">kanteralon@gmail.com</a>
                        </p>
                      </div>
                    </div>
                  </div>
